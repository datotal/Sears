...
if LTL_to_PARCEL.shape[0]>1:
    ...
    st.write(LTL_to_PARCEL[[count,shipper_zip,consignee_zip,carriername,'Dim Weight',charge,'Estimated PARCEL$','Savings']].reset_index(drop=True))
