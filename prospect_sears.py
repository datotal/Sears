...
LTL_to_PARCEL=df_ltl[(df_ltl[weight]<150)& (df_ltl['Dim Weight']<150)]
# LTL_to_PARCEL['cpp']=costPerPound(LTL_to_PARCEL,'PARCEL')
# LTL_to_PARCEL=LTL_to_PARCEL[LTL_to_PARCEL['cpp']!=0]
LTL_to_PARCEL['Estimated PARCEL$']=1.075*LTL_to_PARCEL['Dim Weight']
if LTL_to_PARCEL.shape[0]>1:
    ...
    st.write(LTL_to_PARCEL[[count,shipper_zip,consignee_zip,carriername,weight,'Dim Weight',charge,'Estimated PARCEL$','Savings']].reset_index(drop=True))
